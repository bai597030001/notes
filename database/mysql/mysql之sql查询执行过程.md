...
```mysql
mysql > EXPLAIN select AffairID from (select AffairID from CallInterruptionTable_C3 where StartTime > 20190927202030928 and StopTime < 20190927222049861) as c3Table;
```
